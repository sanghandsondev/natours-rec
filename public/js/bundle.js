      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Create new account successfully');
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Token sent to email. Check your email');
            }
...
function () {
  ...
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee5(data, resetToken) {
    var res;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Your password has changed');
              window.setTimeout(function () {
                location.assign('/');
              }, 2000);
            }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " update successfully")); // location.reload(true)                   // reload lại trang
            }
...
if (updateDataForm) {
  updateDataForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var form = new FormData(); // 1 object req.body từ input của form

    form.append('name', document.getElementById('name').value);
    form.append('email', document.getElementById('email').value);
    form.append('photo', document.getElementById('photo').files[0]);
    (0, _account.updateData)(form, 'data'); // const name = document.getElementById('name').value
